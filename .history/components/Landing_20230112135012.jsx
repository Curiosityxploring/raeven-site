            ...
            <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
              <div>
                ...
                <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                  We allow you to easily and sell without any having a big shop, with just a few steps you become a shop owner on the raeven platforma and reach to as much customersfrom around the world
                </p>
              </div>
